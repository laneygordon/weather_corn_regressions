...
county_summer_yield$meantsmaxsq <- county_summer_yield$meantmax^2  

#linear model
lm_Q3 <- lm(yield ~ meantmax + meantmaxsq, data = county_summer_yield) 
summary(lm_Q3) 

#quadratic
county_summer_yield$fitted <- lm_Q3$fitted.values 
...
```
Based on the plot, there does not appear to be a relationship between the meantmax and yield. Additionally, the p-value of 0.063 is greater than alpha, which assures us that we do not have significant evidence of a relationship between the two.  
...
```
This code was found on [github](https://jtr13.github.io/cc19/different-ways-of-plotting-u-s-map-in-r.html) 
